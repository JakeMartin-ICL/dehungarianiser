...
[ZoneDefinition]
public class DehungarianiserTestEnvironmentZone : ITestsEnvZone, IRequire<PsiFeatureTestZone>,
    IRequire<IDehungarianiserZone>
{
}

[ZoneMarker]
public class ZoneMarker : IRequire<ICodeEditingZone>, IRequire<ILanguageCSharpZone>,
    IRequire<DehungarianiserTestEnvironmentZone>
{
}
